...
$templateCache.put("examples/simpleIntro__eruminate.html","<div style=\"background-color: white; border: 1px solid gray; border-radius: 5px; max-width: 300px\" class=\"container\"><div class=\"row\"><div class=\"col-sm-12\"><h4>Rendolent Erumination</h4><p>This is a quick explanation of how eruminating rendolently can help you be better at your job. You\'re going\nto feel like you\'ve got superpowers after you start using this tool!</p></div></div><div class=\"row\"><div class=\"col-sm-6\"><button ng-click=\"dismissFairy()\" class=\"btn btn-default\">Got it!</button></div><div class=\"col-sm-6\"><a href=\"https://www.youtube.com/watch?v=dQw4w9WgXcQ\" target=\"_blank\">Learn More</a></div></div></div>");}]);