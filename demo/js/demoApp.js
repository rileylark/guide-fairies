...
angular.module("FairyDemo").run(["$templateCache", function($templateCache) {$templateCache.put("examples/explainFeature.html","<div class=\"row\"><div ng-init=\"selectedFeature = &quot;Manage Tasks&quot;\" class=\"col-lg-4\"><div ng-init=\"possibleFeatures = [&quot;Manage Tasks&quot;, &quot;Check Your Email&quot;, &quot;Empower Your Users&quot;, &quot;Analytics&quot;, &quot;Log Out&quot;]\" class=\"btn-group-vertical\"><button ng-repeat=\"feature in possibleFeatures\" ng-click=\"$parent.selectedFeature = feature\" class=\"btn btn-default btn-lg\">{{feature}}</button><button ng-click=\"$parent.selectedFeature = &quot;Eruminate Your Rendolence&quot;\" guide-stop=\"eruminate-your-rendolence\" guide-fairy-class=\"special-fairy-class-for-explainers\" guide-explanation-template-url=\"examples/simpleIntro__eruminate.html\" class=\"btn btn-default btn-lg\">Eruminate Your Rendolence</button></div></div><div class=\"col-lg-8\"><div ng-if=\"$parent.selectedFeature == &quot;Eruminate Your Rendolence&quot;\"><h3>{{selectedFeature}}</h3><p>Honestly, your user has no chance of understanding this crazy interface without at least some context.</p><p>I recommend you redesign until your interface is easy to understand, but if you don\'t have time for that,\nyou could use a fairy to explain something. They are less annoying than modal popups and less invisible\nthan explanatory text.</p></div><div ng-if=\"$parent.selectedFeature != &quot;Eruminate Your Rendolence&quot;\"><h3>{{selectedFeature}}</h3><p>This feature has an easy interface that everyone can quickly understand.</p><p class=\"well\">Note: an explanation might still be useful for helping your users feel powerful, with a tip for\nextremely effective use or an affirmation of how great your user is when he \"{{selectedFeature}}\"s</p></div></div></div>");
